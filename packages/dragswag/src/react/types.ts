...
export type DraggableConfig = {
  ...
  shouldDrag?: (args: { event: MouseEvent; dragStartEvent: MouseEvent; element: HTMLElement; data: any }) => boolean
  onDragStart?: (args: { event: MouseEvent; dragStartEvent: MouseEvent; element: HTMLElement; data: any }) => void
  onDragMove?: (args: {
    event: MouseEvent
