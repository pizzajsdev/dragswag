...
function Placeholder() {
  ...
  return droppable(<div className={cn('placeholder', 'with-animation', !placeholderVisible && 'collapsed')}></div>)
}
    ...
    <DragOverlayProvider>
      <div className="app">
        <div className="items-list">
          {items.map((item) => (
            <Item key={item.index} text={item.text} index={item.index} moveItem={_moveItem} />
          ))}
        </div>
